...
public class CarDAOImpl implements CarDAO {
    ...
    public List<CarType> getCarTypes() {
        TypedQuery<CarType> carQuery = entityManager.createNamedQuery("CarType.getAll", CarType.class);
        return carQuery.getResultList();
    }

    @Override
    public List<Car> getAllCarsByType(CarType carType) {
       TypedQuery<Car> carQuery = entityManager.createNamedQuery("Car.getAllCarByType", Car.class);
       carQuery.setParameter("type", carType);
       return carQuery.getResultList();
    }
}
